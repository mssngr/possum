...
class UncontrolledDateTimePicker extends React.Component {
  /**
...
UncontrolledDateTimePicker.propTypes = {
...
UncontrolledDateTimePicker.DateInputBlock = DateInputBlock
UncontrolledDateTimePicker.Calendar = Calendar
